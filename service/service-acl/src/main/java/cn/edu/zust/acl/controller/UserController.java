...
public class UserController {
    ...
    @PostMapping("save")
    public ResultMode save(@RequestBody User user) {
    ...
    @PutMapping("update")
    public ResultMode updateById(@RequestBody User user) {
    ...
    public ResultMode toAssign(@PathVariable String userId) {
        Map<String, Object> roleMap = roleService.findRoleByUserId(userId);

        return ResultMode.ok(roleMap);
    }

    @ApiOperation(value = "根据用户分配角色")
    @PostMapping("/doAssign")
    public ResultMode doAssign(@RequestParam String userId,@RequestParam String[] roleId) {
